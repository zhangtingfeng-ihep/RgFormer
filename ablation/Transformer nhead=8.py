...
# Set up logging
logging.basicConfig(filename='C:\\SASBDB\\model\\49\\train.log', level=logging.INFO,
                    format='%(asctime)s - %(levelname)s - %(message)s')

# Define the model class without channel attention and positional encoding
class ImprovedSAXSModel(nn.Module):
    def __init__(self, input_dim=2, d_model=512, nhead=8, num_layers=4, dim_feedforward=2048, max_length=2617,
                 dropout=0.2):
...
def train_model():
    ...
    model = ImprovedSAXSModel(input_dim=2, d_model=512, nhead=8, num_layers=4, dim_feedforward=2048,
