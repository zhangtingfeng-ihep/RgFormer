...
# Set up logging
logging.basicConfig(filename='C:\\SASBDB\\model\\37\\train.log', level=logging.INFO,
                    format='%(asctime)s - %(levelname)s - %(message)s')

# Define the model class without channel attention, positional encoding, and layer normalization
class ImprovedSAXSModel(nn.Module):
    ...
    def forward(self, x, mask):
        ...
        x = x.mean(dim=1)  # Removed layer normalization
        residual = x
