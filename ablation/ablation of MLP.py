...
# Set up logging
logging.basicConfig(filename='C:\\SASBDB\\model\\35\\train.log', level=logging.INFO,
                    format='%(asctime)s - %(levelname)s - %(message)s')

# Define the model class without channel attention, positional encoding, and MLP
class ImprovedSAXSModel(nn.Module):
    def __init__(self, input_dim=2, d_model=512, nhead=16, num_layers=4, dim_feedforward=2048, max_length=2617,
        ...
        # Replace MLP with a single linear layer to output 1 value
