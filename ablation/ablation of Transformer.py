...
# Set up logging
logging.basicConfig(filename='C:\\SASBDB\\model\\46\\train.log', level=logging.INFO,
                    format='%(asctime)s - %(levelname)s - %(message)s')

# Define the model class without Transformer layer
