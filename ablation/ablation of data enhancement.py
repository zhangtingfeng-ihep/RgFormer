...
# Set up logging
logging.basicConfig(filename='D:\\SASBDB\\model\\42\\train.log', level=logging.INFO,
...
# Load and preprocess data with per-sample normalization
def load_data():
