...
# Set up logging
logging.basicConfig(filename='C:\\SASBDB\\model\\38\\train.log', level=logging.INFO,
...
# Define the dataset class without sample weights
...
def train_model():
    ...
    for epoch in range(num_epochs):
        ...
        for batch in train_loader:
            ...
            scaler.update()
            train_loss += loss.item() * len(batch['rg'])
        ...
        with torch.no_grad():
            for batch in val_loader:
                ...
                val_loss += loss.item() * len(batch['rg'])
